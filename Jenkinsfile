pipeline{
    ...
    environment {
        ...
        AWS_ACCESS_KEY = credentials('secret.aws_access_key_id')   // Jenkins credential ID
        AWS_SECRET_KEY = credentials('secret.aws_secret_access_key') // Jenkins credential ID
...
//i am adding this line to test number 19